...
left, bottom, width, height = [0.68, 0.22, 0.20, 0.15]
...
#ax1.plot(En2, Tn2, linewidth=0.4, label='L=18')
legend = ax1.legend(loc='lower right', shadow=False, fontsize='x-large')

with open('DISP01z1_16_6.dat') as f:
    lines = f.readlines()
