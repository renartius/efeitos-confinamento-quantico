...
file210 = open("EEzvsTTz1_"+ str(MQPC1z1)+"_"+str(NWz1) +".dat", "w")
file340 = open("DISP01z1_"+ str(MQPC1z1)+"_"+str(NWz1) +".dat", "w")
file360 = open("GvsFMEz1_"+ str(MQPC1z1)+"_"+str(NWz1) +".dat", "w")
...
WBz1 = NDz1
yyz1 = 0 # 4            # se for usar QPC, yyz1 = 4
for iyz1 in range(1, WBz1+1):
    yy1z1 = yyz1 + iyz1
    for imz1 in range(1, 2):
