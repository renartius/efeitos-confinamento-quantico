...
MOQD2z1 = LxLy
MOQD3z1 = 0 #LxLy
NMz1 = 2*MCz1+MQPC1z1+MOQDz1+MQPC2z1 + MOQD2z1+MQPC3z1 + MOQD3z1+MQPC4z1
...
HQPC3z1 = np.zeros((NDz1, NDz1), dtype='complex', order='F')
HQPC4z1 = np.zeros((NDz1, NDz1), dtype='complex', order='F')
HOQDz1 = np.zeros((NDz1, NDz1), dtype='complex', order='F')
HOQD2z1 = np.zeros((NDz1, NDz1), dtype='complex', order='F')
HOQD3z1 = np.zeros((NDz1, NDz1), dtype='complex', order='F')
...
file210 = open("EEzvsTTz2_"+ str(L)+"_"+str(NWz1) +".dat", "w")
file340 = open("DISP01z2_"+ str(L)+"_"+str(NWz1) +".dat", "w")
file360 = open("GvsFMEz2_"+ str(L)+"_"+str(NWz1) +".dat", "w")
...
for ixz1 in range(0,NDz1):
    for jxz1 in range(0,NDz1):
        ...
        HQPC3z1[jxz1, ixz1] = z0z1
        HQPC4z1[jxz1, ixz1] = z0z1


for ixz1 in range(0,NDz1):
    for jxz1 in range(0, NDz1):
        HOQDz1[jxz1, ixz1] = z0z1
        HOQD2z1[jxz1, ixz1] = z0z1
        HOQD3z1[jxz1, ixz1] = z0z1
...
# ** ** ** ** ** ** ** QPC3 ** ** ** ** ** ** ** **
# ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
HQPC3z1 = HQPC1z1.copy()

# ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
# ** ** ** ** ** ** ** QPC4 ** ** ** ** ** ** ** **
# ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
HQPC4z1 = HQPC1z1.copy()
...
for iyz1 in range(1, WBz1+1-(2*temp_DOT)):
    ...
    for imz1 in range(1, 2):
        ...
        HOQD2z1[yy1z1 + (imz1 - 1) * NDz1 - 1, yy1z1 + (imz1 - 1) * NDz1 - 1] = EAz1 * zrz1
        HOQD3z1[yy1z1 + (imz1 - 1) * NDz1 - 1, yy1z1 + (imz1 - 1) * NDz1 - 1] = EAz1 * zrz1
...
# CALCULAR A MATRIZ MDUXz SIMILAR QUE A CALCULADA GUz(funcao de Green contato)
        ...
        jxz1 = MCz1+MQPC1z1+MOQDz1 + MQPC2z1+MOQD2z1
        for imz1 in range(MQPC3z1, 0, -1):
            # ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** *
            # ** ** ** ** ** ** ** ** * DISPOSITIVO ** ** ** ** ** ** ** ** **
            jyz1 = 0
            jxz1 = jxz1+1
...
# ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **
        ...
        jxz1 = MCz1 + MQPC1z1 + MOQDz1 + MQPC2z1 + MOQD2z1 + MQPC3z1
        #  ###########################################################
        # REDE DE ANTIDOTS
        #  ##########################################################
        ...
        jxz1 = MCz1 + MQPC1z1 + MOQDz1 + MQPC2z1 + MOQD2z1 + MQPC3z1 + MOQD3z1
        for imz1 in range(MQPC4z1, 0, -1):
            # ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** *
            # ** ** ** ** ** ** ** ** * DISPOSITIVO ** ** ** ** ** ** ** ** **
            jyz1 = 0
            jxz1 = jxz1+1
        ...
        # jxz1=MCz1+MQPC1z1
        jxz1 = MCz1+MQPC1z1+MOQDz1 + MQPC2z1+MOQD2z1+MQPC3z1 + MOQD3z1 + MQPC4z1
        for imz1 in range(MCz1, 0, -1):
            # ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** *
            # ** ** ** ** ** ** ** ** * DISPOSITIVO ** ** ** ** ** ** ** ** **
            jyz1 = 0
