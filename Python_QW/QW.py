...
file210 = open("EEzvsTTz1_"+ str(NWz1) +".dat", "w")
file340 = open("DISP01z1_"+ str(NWz1) +".dat", "w")
file360 = open("GvsFMEz1_"+ str(NWz1) +".dat", "w")
...
left, bottom, width, height = [0.2, 0.6, 0.2, (NDz1/100)]
